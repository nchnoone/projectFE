  ...
  return <footer className='pt-16 bg-primary'>
    <div className="container mx-auto">
      <div className='text-center'>
        <h2 className='h2 uppercase mb-6 font-semibold'>Subscribe to ournewletter</h2>
        <p className='text-white/70'>Be the first to get the latest news ablout trends, promotions anh much more</p>
      </div>
      {/* form */}
      ...
      {/* socials */}
      <div className='flex gap-x-6 max-w-max mx-auto mb-16'>
        <a href="/" className='hover:text-white transition-all'>
          <FaYoutube />
        </a>
        <a href="/" className='hover:text-white transition-all'>
