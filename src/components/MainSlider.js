            ...
            <SwiperSlide key={index}>
              <div className='flex flex-col lg:flex-row h-full p-[20px] md:p-[60px]'>
                ...
                <div className='w-full lg:flex-1'>
                  ...
                  <div className='text-3xl md:text-[46px] font-medium uppercase leading-none text-center lg:text-left mb-8 xl:mb-20'>
                    {slide.titlePart1} <br />
                    {slide.titlePart2} <br />
                    {slide.titlePart3}
                  </div>
                  <button className='btn btn-accent mx-auto lg:mx-0'>{slide.titlePart4}</button>
                </div>
                {/* img */}
